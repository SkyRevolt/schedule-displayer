...
public class Display extends javax.swing.JFrame{
    ...
    public class tasktype{
        ...
        this.qran = rng.nextInt(maxquick);
        this.pran = rng.nextInt(maxprolonged);
        this.vran = rng.nextInt(maxvisual);
        this.cran = rng.nextInt(maxcommon);
    }
    ...
    public class task {
        ...
        this.qset = quick[this.qran];
        this.pset = prolonged[this.pran];
        this.vset = visual[this.vran];
        this.cset = common[this.cran];
    }                    
